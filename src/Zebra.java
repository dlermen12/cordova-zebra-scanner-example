...
public class Zebra extends CordovaPlugin {
  ...
  public static final String TAG = Zebra.class.getSimpleName();
...
class ZebraTransferListener implements FTPDataTransferListener {
  public static final String TAG = ZebraTransferListener.class.getSimpleName();
  private long totalSize = 0;
  private long curSize = 0;
  private CallbackContext callbackContext = null;
  private PluginResult pluginResult = null;

  public ZebraTransferListener(long size, CallbackContext callbackContext) {
    this.totalSize = size;
